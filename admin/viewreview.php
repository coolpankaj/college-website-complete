...
$q = "select * from review LIMIT $start, $perPage";
...
while ($r=$qry->fetch_array())
 {
             ...
             echo "<tr><td>".$r[0]."</td>";
              echo "<td>".$r[1]."</td>";
               ...
               echo "<td>".$r[4]."</td>";
                        ...
                        echo "<td><a href='deletereview.php?rv=$r[0]'>Delete</a></td>";
		 ...
		 <tr>
			...
			{
			$pre=$page-1;
			echo "<a href='viewreview.php?page=$pre'>Previous&nbsp;&nbsp;</a>";
			}
			else
			{
			$pre=1;
			...
			for($i=1 ;$i<=$totalPage; $i++)
			{
				...
				echo "<a href='viewpageing.php?page=$i'>$i</a> &nbsp;&nbsp;| &nbsp;&nbsp;";
			...
			{
			$next=$page+1;
			echo "<a href='viewpageing.php?page=$next'>next</a>";
